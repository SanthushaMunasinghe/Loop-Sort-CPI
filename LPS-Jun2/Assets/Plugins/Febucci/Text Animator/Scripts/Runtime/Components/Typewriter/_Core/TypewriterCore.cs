...
namespace Febucci.UI.Core
{
    ...
    /// See the local package documentation for custom typewriter guidance.
    /// </remarks>
    ...
    public abstract class TypewriterCore : MonoBehaviour
    {
        ...
        /// See the local package documentation for event details.
        /// </summary>
        /// <remarks>
        /// It is only invoked when the typewriter is enabled.
        /// </remarks>
        ...
        /// See the local package documentation for Text Animator Players.
        /// </summary>
