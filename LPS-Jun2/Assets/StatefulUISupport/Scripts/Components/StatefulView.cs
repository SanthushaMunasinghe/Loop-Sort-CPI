...
namespace StatefulUISupport.Scripts.Components
{
    public abstract class StatefulView : MonoBehaviour, IStatefulView
    {
        ...
        public Button GetButton(ButtonRole role)
            => _statefulComponent.GetButton(role);
        ...
        public Image GetImage(ImageRole role)
            => _statefulComponent.GetImage(role);
        ...
        public void SetText(TextRole role, string text)
            => _statefulComponent.SetText(role, text);

        public void SetTextValues(TextRole role, params string[] values)
            => _statefulComponent.SetTextValues(role, values);

        public void SetFormattedText(TextRole role, params string[] values)
            => _statefulComponent.SetFormattedText(role, values);
        ...
        public void SetImage(ImageRole role, IconInfo iconInfo)
            => _statefulComponent.SetImage(role, iconInfo);

        public void SetButtonListener(ButtonRole role, UnityAction listener)
            => _statefulComponent.SetButtonListener(role, listener);
